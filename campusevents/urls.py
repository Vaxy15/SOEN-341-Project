...
urlpatterns = [
    ...
    path("api/events/<int:pk>/calendar/ics/", views.EventCalendarView.as_view(), name="event_calendar_ics"),
    path("api/events/<int:pk>/calendar/google/", views.EventGoogleCalendarView.as_view(), name="event_calendar_google"),
